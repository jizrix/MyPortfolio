    ...
    <div className='flex flex-col w-full lg:flex-row mt-4'>
      <div className='flex flex-col w-[40%] justify-center h-screen bg-base-300 p-[6rem]'>
        <div className='flex flex-col justify-center'>
          ...
          <p className='text-[3rem] leading-[1] tracking-wider font-bold mb-6'>
            i'm Weerapan.
          </p>
          ...
          <div className='text-[1rem] text-right'>Photo: Weerapan.</div>
          <div className=''>
            <h4 className='text-[1.5rem] font-bold py-3'>
              here's how i came here...
            </h4>
            <p className='text-[1.25rem]'>
              I loved creating with LEGO bricks as a kid. Discovering LEGO
              Mindstorms, which let me build and program robots, ignited my
              passion for coding. I joined WRO and earned 6th place in the South
              East Asia.
            </p>
          </div>
        </div>
      ...
      <div className='flex flex-col w-[60%] h-screen bg-base-200 p-[7rem]'>
        <section id='interests' className='h-1/3 flex flex-col justify-center'>
          ...
          <div className='flex flex-row'>
            ...
            <div className='flex flex-col w-1/2 items-start'>
              <div className='flex flex-col justify-center items-start'>
                ...
                <Link to={'https://github.com/jizrix'} target='_blank'>
                  <div className='flex flex-row justify-center py-2'>
